...
# This is +3 ie outside essential slice site. Is this a bug in VEP? is 10AJ04668 DCM	DSP	chr6: g.[7569571CAAGT>C]	c.1574+3_1574+6delAAGT  splice donor variant & coding sequence variant
#Update the bash script in this GIT repo. Current one is too old. 
# Check the that path to /data... isn't in bash script or any script. Security risk
# Supp Table - The Final EDD column has initial on it ... fix update_Variable_Names_for_manuscript function : Initial Left ventricular end-diastolic diameter FINAL 
