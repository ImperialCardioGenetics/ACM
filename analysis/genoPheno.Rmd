...
update_rownames_characteristics <- function(x){
  ...
  x_rowNames<- gsub(x = x_rowNames,pattern = "FAMILY_HISTORY_OF_SUDDEN_CARDIAC_DEATH", replacement = "Family history of SCD",fixed = TRUE)
...
colnames(GroupTable) <- c("ACM <br> (n=141)","DCM <br> (n=366)","HVOL <br> (n=445)")
