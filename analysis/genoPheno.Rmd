...
## Table 1 - for internal use. Includes missing data count
```{r}
Table1_extra<-MainTable[,c("3","2","1","6","5","4","7")]

colnames(Table1_extra) <- c("TTNtv <br>(n=14)","Genotype Neg <br>(n=122)","Other Variants <br>(n=5)","TTNtv <br>(NA's)","Genotype Neg <br>(NA's)","Other Variants <br>(NA's)","P-value <br>(TTNtv vs Genotype Neg)")
