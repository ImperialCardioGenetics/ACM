...
GroupTable1<-GroupTable1[,c("AGE_AT_scan","EF","DD","SEX","Ethnicity")]
GroupTable2<-GroupTable2[,c("AGE_AT_scan","EF","DD","SEX","Ethnicity")]
...
rownames(GroupTable) <- c("Age at scan", "EF[MRI/ECHO]","DD/LVEDV","Sex (male)","Ethnicity (caucasian)")
