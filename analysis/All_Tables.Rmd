...
# DCM_demo & HVOL_demo : the infiles for these won't be shared with the world. Would it be worth seperating the code this it? So at least this script can run smoothly
...
#firstup("i like pizza very much")
